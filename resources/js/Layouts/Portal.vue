...
const url_asset = ref(g_url_assets);
</script>
<template>
    <!-- BEGIN #app -->
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="promotion promotion-lg bg-dark">
                            <div
                                class="promotion-image text-end promotion-image-overflow-bottom"
                            >
                                <img
                                    src="/assets/portal/img/product/product-iphone-12.png"
                                    alt=""
                                />
                            </div>
                            <div
                                class="promotion-caption promotion-caption-inverse"
                            >
                                ...
                                <p class="promotion-desc">
                                    A big step for small.<br />A beloved design.
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="promotion bg-blue">
                            ...
                            >
                                <img
                                    src="/assets/portal/img/product/product-apple-watch-sm.png"
                                    alt=""
                                />
                            </div>
                            <div
                                class="promotion-caption promotion-caption-inverse text-end"
                            >
                        ...
                        <div class="promotion bg-gray-200">
                            ...
                            >
                                <img
                                    src="/assets/portal/img/product/product-mac-mini.png"
                                    alt=""
                                />
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="promotion bg-gray-200">
                            <div
                                class="promotion-image promotion-image-overflow-right promotion-image-overflow-bottom text-end"
                            >
                                <img
                                    src="/assets/portal/img/product/product-mac-accessories.png"
                                    alt=""
                                />
                            </div>
                            <div class="promotion-caption text-center">
                        ...
                        <div class="promotion bg-dark">
                            <div class="promotion-image text-end">
                                <img
                                    src="/assets/portal/img/product/product-mac-pro.png"
                                    alt=""
                                />
                            </div>
                            <div
            ...
            <div class="container">
                ...
                <h4 class="section-title clearfix">
                    <span class="flex-1">
                        Trending Items
                        <small
                            >Shop and get your favourite items at amazing
                            prices!</small
                        >
                    </span>
                    <div class="btn-group">
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img
                                    src="/assets/portal/img/product/product-iphone.png"
                                    alt=""
                                />
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img
                                    src="/assets/portal/img/product/product-ipad-pro.png"
                                    alt=""
                                />
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img
                                    src="/assets/portal/img/product/product-imac.png"
                                    alt=""
                                />
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img
                                    src="/assets/portal/img/product/product-apple-watch.png"
                                    alt=""
                                />
                            ...
                            <div class="item-info">
                                <h4 class="item-title">
                                    <a href="product.html"
                                        >Apple Watch<br />Stainless steel
                                        cases</a
                                    >
                                </h4>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img
                                    src="/assets/portal/img/product/product-macbook-pro.png"
                                    alt=""
                                />
                            ...
                            <div class="item-info">
                                <h4 class="item-title">
                                    <a href="product.html"
                                        >MacBook Pro<br />with Retina Display</a
                                    >
                                </h4>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        ...
                        <div class="item item-thumbnail">
                            <a href="product_detail.html" class="item-image">
                                <img
                                    src="/assets/portal/img/product/product-apple-tv.png"
                                    alt=""
                                />
            ...
            <div class="container">
                ...
                <h4 class="section-title clearfix">
                    <span class="flex-1">
                        Mobile Phones
                        <small
                            >Shop and get your favourite phone at amazing
                            prices!</small
                        >
                    </span>
                    <a href="#" class="btn">SHOW ALL</a>
                        ...
                        <a href="#" class="category-item full">
                            <div class="item">
                                <div class="item-cover">
                                    <img
                                        src="/assets/portal/img/product/product-samsung-s7-edge.jpg"
                                        alt=""
                                    />
                                </div>
                                <div class="item-info bottom">
                                    <h4 class="item-title">
                                        Samsung Galaxy s7 Edge + Geat 360 + Gear
                                        VR
                                    </h4>
                                    <p class="item-desc">
                        ...
                        <div class="category-item list">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-samsung-note5.png"
                                            alt=""
                                        />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                            <a href="product.html"
                                                >Samsung Galaxy Note 5<br />Black</a
                                            >
                                        </h4>
                                        <p class="item-desc">
                                            Super. Computer. Now in two sizes.
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-iphone-se.png"
                                            alt=""
                                        />
                                        <div class="discount">20% OFF</div>
                                    </a>
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-zenfone2.png"
                                            alt=""
                                        />
                                        <div class="discount">15% OFF</div>
                                    </a>
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-xperia-z.png"
                                            alt=""
                                        />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-lumia-532.png"
                                            alt=""
                                        />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                            <a href="product.html"
                                                >Microsoft Lumia 531<br />Smartphone
                                                Orange</a
                                            >
                                        </h4>
                                        <p class="item-desc">
            ...
            <div class="container">
                ...
                <h4 class="section-title clearfix">
                    <span class="flex-1">
                        Tablet
                        <small
                            >Shop and get your favourite tablet at amazing
                            prices!</small
                        >
                    </span>
                    <a href="#" class="btn">SHOW ALL</a>
                    ...
                    <div class="category-detail">
                        ...
                        <a href="#" class="category-item full">
                            <div class="item">
                                <div class="item-cover">
                                    <img
                                        src="/assets/portal/img/product/product-huawei-mediapad.jpg"
                                        alt=""
                                    />
                                </div>
                                <div class="item-info bottom">
                                    ...
                                    <p class="item-desc">
                                        Vibrant colors. Beautifully displayed
                                    </p>
                        ...
                        <div class="category-item list">
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-galaxy-tab2.png"
                                            alt=""
                                        />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                            <a href="product.html"
                                                >Samsung Galaxy Tab S2<br />Black</a
                                            >
                                        </h4>
                                        <p class="item-desc">
                                            A Brilliant Screen That Adjusts to
                                            You
                                        </p>
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-galaxy-taba.png"
                                            alt=""
                                        />
                                        <div class="discount">20% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                            <a href="product.html"
                                                >Samsung Galaxy Tab A<br />9.7"
                                                16Gb(Wi-Fi)</a
                                            >
                                        </h4>
                                        <p class="item-desc">
                                            Keep All Your Samsung Devices In
                                            Sync
                                        </p>
                            ...
                            <div class="item-row">
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-hp-spectrex2.png"
                                            alt=""
                                        />
                                        <div class="discount">15% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                            <a href="product_detail.html"
                                                >HP Spectre x2<br />‏12-a011nr</a
                                            >
                                        </h4>
                                        <p class="item-desc">
                                            Our thinnest detachable separates
                                            from all others.
                                        </p>
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-xperia-z2.png"
                                            alt=""
                                        />
                                        <div class="discount">32% OFF</div>
                                    </a>
                                    <div class="item-info">
                                        <h4 class="item-title">
                                            <a href="product.html"
                                                >Sony Xperia Z2 Tablet<br />Black
                                                Color</a
                                            >
                                        </h4>
                                        <p class="item-desc">
                                ...
                                <div class="item item-thumbnail">
                                    ...
                                    >
                                        <img
                                            src="/assets/portal/img/product/product-ipad-air.png"
                                            alt=""
                                        />
                                        <div class="discount">20% OFF</div>
                                    </a>
                    ...
                    <div class="col-lg-4 col-md-4 mb-4 mb-md-0">
                        ...
                        <div class="policy">
                            ...
                            <div class="policy-info">
                                ...
                                <p>
                                    Cras laoreet urna id dui malesuada gravida.
                                    <br />Duis a lobortis dui.
                                </p>
                            </div>
                        </div>
                        <!-- END policy -->
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="policy">
                            ...
                            <div class="policy-info">
                                ...
                                <p>
                                    Fusce ut euismod orci. Morbi auctor, sapien
                                    non eleifend iaculis.
                                </p>
                            </div>
                        </div>
                        <!-- END policy -->
