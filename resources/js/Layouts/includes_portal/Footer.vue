            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <p>
                        ...
                        Sed nec tristique dolor, ac efficitur velit. Nulla
                        lobortis tempus convallis. Nulla aliquam lectus eu porta
                        pulvinar. Mauris semper justo erat.
                    </p>
                    <p class="mb-lg-4 mb-0">
                        Vestibulum porttitor lorem et vestibulum pharetra.
                        Phasellus sit amet mi congue, hendrerit mi ut, dignissim
                        eros.
                    </p>
                </div>
                <!-- END col-3 -->
                ...
                <div class="col-lg-3">
                    ...
                    <ul class="list-unstyled list-product mb-lg-4 mb-0 p-0">
                        <li>
                            <div class="image">
                                <img
                                    src="/assets/portal/img/product/product-iphone-6s.jpg"
                                    alt=""
                                />
                            </div>
                            <div class="info">
                        ...
                        <li>
                            <div class="image">
                                <img
                                    src="/assets/portal/img/product/product-galaxy-s6.jpg"
                                    alt=""
                                />
                            </div>
                            <div class="info">
                        ...
                        <li>
                            <div class="image">
                                <img
                                    src="/assets/portal/img/product/product-ipad-pro.jpg"
                                    alt=""
                                />
                            </div>
                            <div class="info">
                        ...
                        <li>
                            <div class="image">
                                <img
                                    src="/assets/portal/img/product/product-galaxy-note5.jpg"
                                    alt=""
                                />
                            </div>
                            <div class="info">
    ...
    <div id="footer-copyright" class="footer-copyright">
        ...
        <div class="container">
            <div class="payment-method">
                <img
                    src="/assets/portal/img/payment/payment-method.png"
                    alt=""
                />
            </div>
            <div class="copyright">
